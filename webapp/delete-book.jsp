...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Barlow+Condensed&family=Quicksand:wght@400;700&display=swap" rel="stylesheet">
    <style>
        body {
            font-family: 'Quicksand', sans-serif;
            background-color: #f1f1f1; /* 연한 브라운 색상 */
            margin: 0;
            padding: 0;
            ...
            <tbody>
                <%
                    ...
                    try {
                        ...
                        // 초성 검색을 위한 정규식 쿼리 수정
                        String query = "SELECT title, writer, isbn, sort FROM books WHERE title REGEXP '^" + searchKeyword + "' LIMIT ? OFFSET ?";
                ...
                <%
                        ...
                        String countQuery = "SELECT COUNT(*) FROM books WHERE title REGEXP '^" + searchKeyword + "'";
