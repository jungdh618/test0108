...
<head>
    ...
    <title>Search Books Starting with Korean Characters</title>
    <style>
/* 전체 배경 색상 */
        body {
            ...
            <tbody>
                <%
                    ...
                    try {
                        ...
                        // 한글 초성 'ㄷ'으로 시작하는 책을 검색하는 쿼리
                        String query = "SELECT title, writer, sort, isbn FROM books WHERE title REGEXP '^[하-힣].*'";
                ...
                %>
                        <tr><td colspan="3" class="error-message">Error: <%= e.getMessage() %></td></tr>
                <%
                    }
                %>
            </tbody>
